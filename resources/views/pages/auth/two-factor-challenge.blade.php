<x-layouts::auth :title="__('Autenticação 2FA')">
        ...
        >
            <div x-show="!showRecoveryInput">
                <x-auth-header
                    ...
                    :description="__('Insira o código fornecido por seu aplicativo de autenticação.')"
                />
            </div>
            ...
            <div x-show="showRecoveryInput">
                <x-auth-header
                    ...
                    :description="__('Confirme o acesso à sua conta inserindo um dos seus códigos de recuperação de emergência.')"
                />
            </div>
